...
from atarashi.libs.utils import cosine_similarity, wordFrequency
...
class NgramAgent(AtarashiAgent):
    ...
    def scan(self, inputFile):
        ...
        if (
            self.simType == self.NgramAlgo.bigramCosineSim
            and len(Bigram_cosine_matches) > 0
        ):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "processedLicenseList", help="Specify the processed license list file"
    )
